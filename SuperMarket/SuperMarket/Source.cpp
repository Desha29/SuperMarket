...
void discount();         //--> Discount for orders above 2000 L.E .  

void gift();             //--> Gifts for orders above 6000 L.E .
...
void sign()   //--> Sign up.
{
    user.open("Users.txt", ios::app | ios::out);
    cout << "\n\033[36mEnter Name:\033[0m \n";
    cin >> u.name;                   //name 
    cin.ignore();
...
void profile()  //--> View profile of user.
{
    ...
    cout << "|                |                                        |            \n";
    cout << "|   Phone number:|   " << "+2 | " << u1[numOFuser].phone << "\t\t\t  | \n";
    cout << "|                |                                        |            \n";
...
void totalprice()  //--> Calculating total price for order.
{
    ...
    cout << "\033[33m-----------------------------------------------------------------------------------------\033[0m\n\n\n";
    orders.open("Orders.txt", ios::app | ios::out);
...
z:
    ...
    {
        cout << "\n\033[33m*****************************************\n";
        cout << "\n* Your gift is 2500 L.E discount coupon  *\n";
        cout << "\n*****************************************\033[0m\n";
        order.totalprice -= 2500;                                            //2500 LE
        view();
    ...
    {
        cout << "\n\033[33m********************************************\n";
        cout << "\n* Your gift is 40% disscount on your order *\n";
        cout << "\n********************************************\033[0m\n";
        order.totalprice -= order.totalprice * 0.4;                        //40% discount    
        view();
        cout << "\033[36m Total price after disscount=\033[0m " << order.totalprice << "  L.E" << endl;
    }
    ...
    {
        cout << "\n\033[33m***********************************************\n";
        cout << "\n* Your gift is 6 bottle of pepsi(1L) for free *\n";
        cout << "\n***********************************************\033[0m\n";   //6 bottle of pipse(1L)
        view();
        ...
        cout << "\033[33m|  " << Drinks[8].Code << " \t|\t" << Drinks[8].Name << "\t|\t" << "Free" << "\t|\t" << "6" << "\t|\t" << Drinks[8].Proddate << "\t|\t" << Drinks[8].Expiredate << "   | " << "--------" << "\t      |\n";
        cout << "|\t|  \t\t\t|\t\t|\t\t|\t\t\t|\t\t    |\t\t      |\n";
    ...
    else if (giftcode == "8733")
    {
        ...
        cout << "\n*****************************************\033[0m\n";
        order.totalprice -= order.totalprice * 0.3;                                        //30% L.E
        view();
